...
export default function SignupPage() {
  ...
  return (
    <>
      <Head>
        <title>Signup | TriMerge IQ</title>
      </Head>
      <main className="min-h-screen bg-[#ECEFF6] px-4 py-10 sm:px-6 sm:py-14">
        ...
        <section className="rounded-3xl bg-white/90 p-6 shadow-[0_12px_35px_rgba(26,61,130,0.12)] ring-1 ring-white/70 sm:p-8">
          <h2 className="mb-6 text-center text-2xl font-semibold text-[#334E8A]">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            />
            <p className="-mt-2 text-xs text-slate-500">Use 8 or more characters with at least one uppercase letter, one number, and one special character.</p>
